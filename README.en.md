...
This repository is a frontend-separation and API-focused fork based on the upstream SequenceServer project.

Chinese documentation is the primary entry point for this fork:
...
The original English README content from upstream is retained below as a secondary reference.
